...
def layers(vgg_layer3_out, vgg_layer4_out, vgg_layer7_out, num_classes):
    ...
    unsample1 = tf.layers.conv2d_transpose(
        conv1x1_7,
        num_classes,
        4,
        strides=(2, 2),
    ...
    skip1 = tf.add(unsample1, conv1x1_4)
    unsample2 = tf.layers.conv2d_transpose(
        skip1,
        num_classes,
        4,
        strides=(2, 2),
    ...
    skip2 = tf.add(unsample2, conv1x1_3)
    unsample3 = tf.layers.conv2d_transpose(
        skip2,
        num_classes,
        16,
        strides=(8, 8),
